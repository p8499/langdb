...
(		/*field*/
		...
		/*cache*/
		ATCGNAME VARCHAR(32) NOT NULL,
		ATCSA SMALLINT NOT NULL,
		ATCSB SMALLINT NOT NULL,
		ATCSC SMALLINT NOT NULL,
		ATCSD SMALLINT NOT NULL,
		ATCSE SMALLINT NOT NULL,
		ATCSF SMALLINT NOT NULL,
		/*constraint*/
		PRIMARY KEY (ATID),
		UNIQUE (ATCGID,ATSI),
